...
public class JenisMemberFrame extends JFrame {
    ...
    // constructor kelas jenisMemberFrame
    public JenisMemberFrame(JenisMemberDao jenisMemberDao) {
        ...
        labelInput.setBounds(15, 60, 350, 30);
    ...
    // mendapatkan nilai yang dimasukkan ke dalam JTextField
    public String getNama() {
        return textFieldNama.getText();
    }

    //menambahkan objek JenisMember ke dalam tabel dan membersihkan JTextField
