...
public class MemberFrame extends JFrame {
    ...
    private JComboBox<String> comboJenis; // Specify the generic type <String>
    ...
    public MemberFrame(MemberDao memberDao, JenisMemberDao jenisMemberDao) {
        ...
        comboJenis.setBounds(15, 120, 150, 30); // Corrected the case of 'S' in 'ScrollableTable'

        JButton button = new JButton("Simpan");
        button.setBounds(15, 160, 100, 40); // Removed colon at the end
        ...
        this.add(labelJenis);
        this.add(comboJenis);
        this.add(scrollableTable); // Corrected the case of 'S' in 'scrollableTable'
